/**
  *  BitFlags.h - wrapper for enum classes to make them usable as bit-fields.
  *
  *  Original source: https://voithos.io/articles/type-safe-enum-class-bit-flags/
  *  Offered under the MIT license (https://opensource.org/license/MIT)
  *
  **/
